...
rawdata <- read_tsv("transcriptomic-analysis/data/salmon.merged.gene_counts.tsv")
...
# STEP 9 see a summary of the results
...
plotMD(et) 
abline(h = c(-1, 1), col = "blue") #adds lines to the plot

# STEP 12 export the results to a file
et_results %>%
  write_tsv("edger_results.csv")
